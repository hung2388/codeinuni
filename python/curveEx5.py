...
for order in [3,4,5,6,7]:
    ...
    plt.show()
print("after many tried, I found that the higher the order is the lower sum ofsquare of residuals, howerver, after ploting i can witness that order 5 draw the best model,after model 6 it's seem halucinating ")